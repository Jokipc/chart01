                      ...
                      <div class="card-body">
                        ...
                        <form action="<?php echo $action; ?>" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" name="latitude" id="Latitude" class="form-control" value="<?php echo $latitude; ?>" readonly placeholder="Latitude"/>

                                <label class="form-label">Longitude</label>
                                <input type="text" name="longitude" id="Longitude" class="form-control" value="<?php echo $longitude; ?> readonly placeholder="Longitude"/>
                            </div>
