...
<?php $this->load->view('templates/sidebarkpr'); ?>
      ...
      <table style="font-size:12 ; word-spacing: -2px;" width=100% >Bobot :
       ...
       ?>
                    ...
                    <div class="progress-group">
                      ...
                      Total KPR <?= number_format($barkpr1,2),'%' ; ?> 
                      <span class="float-right"><b><?php echo number_format($a_hsl); ?></b>/<b><?php  echo number_format($val->t_kpr/1000000); ?>JT</b> </span>                 
                      <div class="progress progress-sm">
                      <div class="progress-bar bg-primary" style="width:  <?= number_format($barkpr1,2),'%' ;R ?>"></div>
                      </div></div>
                    <!-- /.progress-group -->
                    <div class="progress-group">
                      Total Debitur <?= number_format($bardeb1,2),'%' ; ?>
                      <span class="float-right"><b><?php echo $deb; ?></b>/<b><?php  echo $val->t_debkpr; ?></b></span>
                      <div class="progress progress-sm">
