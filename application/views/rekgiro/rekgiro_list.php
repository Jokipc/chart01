...
<div class="row">
<h2 style="margin-top:0px">Rek Giro List</h2>
...
<section class="content"> 
  <table class="table">
      ...
      <?php endif; ?>
		...
		<?php echo anchor(site_url('rekgiro/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Input Rek Giro</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="<?php echo base_url()?>rekgiro/create_action" method="post">
