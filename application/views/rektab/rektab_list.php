...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Rektab List</h2>
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('rektab/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('rektab/read/'.$rektab->id),'Read'); 
				echo ' | '; 
