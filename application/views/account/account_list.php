...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $account->unit ?></td>
			<td><?php echo $account->purchase ?></td>
			<td><?php echo $account->sale ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('account/read/'.$account->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('account/update/'.$account->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('account/delete/'.$account->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
