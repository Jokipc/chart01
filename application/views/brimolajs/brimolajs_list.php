...
<div class="col-md-6">
<form action="<?php echo site_url('brimolajs/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('brimolajs'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
...
<section class="content">
      ...
      <?php endif; ?>
		...
		<?php echo anchor(site_url('brimolajs/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	    </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url()?>brimolajs/create_action" method="post">
