...
<div class="row">
<h2 style="margin-top:0px">Bristore List</h2>
...
<div class="col-md-6">
<form action="<?php echo site_url('bristore/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('bristore'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
...
<section class="content">
  <table class="table">
            ...
            <?php
            foreach ($bristore_data as $bristore)
            {
                ?>
            <tr>
			    <td width="80px"><?php echo ++$start ?></td>
			    <td><?php echo $bristore->pn ?></td>
			    <td><?php echo $bristore->tgl ?></td>
			    <td><?php echo $bristore->norek ?></td>
			    <td><?php echo $bristore->nama ?></td>
			    <td><?php echo $bristore->no_hp ?></td>
          <?php if($this->session->userdata('id_level')==='1' ):; ?>
      <td>
      <?php
            echo anchor(site_url('bristore/update/'.$bristore->id),'Update'); 
            echo ' | '; 
      			echo anchor(site_url('bristore/delete/'.$bristore->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
            else:;   
      ?>
      </td>
      <?php endif; ?>
        ...
        <div class="row">
            <div class="col-md-6">
                <a href="#" class="btn btn-primary">Total Record : <?php echo $total_rows ?></a>
		            <?php echo anchor(site_url('bristore/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Input Bristore</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="<?php echo base_url()?>bristore/create_action" method="post">
