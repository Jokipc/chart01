...
<section class="content">     
    <table class="table">
      ...
      <td>
      <?php
            echo anchor(site_url('briguna/update/'.$briguna->id),'Update'); 
            echo ' | '; 
      			echo anchor(site_url('briguna/delete/'.$briguna->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
            else:;   
      ?>
      </td>
      <?php endif; ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Input Briguna</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="<?php echo base_url()?>briguna/create_action" method="post">
