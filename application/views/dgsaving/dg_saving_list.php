...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Dg_saving List</h2>
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('dgsaving/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('dgsaving/read/'.$dgsaving->id),'Read'); 
				echo ' | '; 
