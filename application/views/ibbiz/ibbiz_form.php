...
<html>
  ...
  dateFormat: "yy-mm-dd"
    ...
    <div class="content-wrapper" style="min-height: 555.807px;border:0px;  overflow:auto; float:left; width:100%">
        <h2 style="margin-top:0px">IBBIZ <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="varchar">No Rek <?php echo form_error('norek') ?></label>
	    ...
	    <a href="<?php echo site_url('ibbiz') ?>" class="btn btn-default">Cancel</a>
	</form>
        </div>
    </body>
</html>
