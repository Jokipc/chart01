...
class Brimolajs extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Brimolajs_model');
    ...
    public function index()
    {
        ...
        // );
            ...
            $config['total_rows'] = $this->Brimolajs_model->total_rows($pn1);
            $config['per_page'] = 10;
            $brimolajs = $this->Brimolajs_model->get_limit_data1($config['per_page'], $start, $pn1);
        $config['page_query_string'] = TRUE;
        $this->load->library('pagination');
        $this->pagination->initialize($config);
        ...
        //     'start' => $start,
        // );
       $this->load->view('brimolajs/brimolajs_list', $data);
       $this->load->view('templates/footer');
    }

    public function read($id) 
    {
        $row = $this->Brimolajs_model->get_by_id($id);
        if ($row) {
            $data = array(
		'id' => $row->id,
		'pn' => $row->pn,
		...
		'nama' => $row->nama,
            ...
            $this->load->view('brimolajs/brimolajs_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('brimolajs'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('brimolajs/create_action'),
	    'id' => set_value('id'),
	    'pn' => set_value('pn'),
	    'tgl' => set_value('tgl'),
        ...
        $this->load->view('brimolajs/brimolajs_form', $data);
    }
    ...
    public function create_action() 
    {
		...
		'nama' => $this->input->post('nama',TRUE),
            ...
            $this->Brimolajs_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('brimolajs/update_action'),
    ...
    public function update_action() 
    {
		...
		'nama' => $this->input->post('nama',TRUE),
            ...
            $this->Brimolajs_model->update($this->input->post('id', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Brimolajs_model->delete($id);
...
/* End of file Brimolajs.php */
/* Location: ./application/controllers/Brimolajs.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2022-03-08 13:31:55 */
/* http://harviacode.com */