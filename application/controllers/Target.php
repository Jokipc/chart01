...
class Target extends CI_Controller
{
    ...
    {
        $this->load->view('target/mantri_list');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Target_model->json();
    }
    ...
    public function read($id) 
    {
		...
		'stroberikasir' => $row->stroberikasir,
            ...
            $this->load->view('target/mantri_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->load->view('target/mantri_form', $data);
    }
    ...
    public function update($id) 
    {
		...
		'trx_pasarid' => set_value('trx_pasarid', $row->trx_pasarid),
    ...
    public function update_action() 
    {
		...
		'stroberikasir' => $this->input->post('stroberikasir',TRUE),
            ...
            $this->Target_model->update($this->input->post('id_pn', TRUE), $data);
	...
	$this->form_validation->set_rules('ico', 'ico', 'trim|required');
	...
	$this->form_validation->set_rules('trx_pasarid', 'trx pasarid', 'trim|required');
	...
	foreach ($this->Target_model->get_all() as $data) {
            $kolombody = 0;
