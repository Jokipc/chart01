...
class Brimo extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'brimo/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'brimo/index.html?q=' . urlencode($q);
        } else {
        ...
        $config['total_rows'] = $this->Brimo_model->total_rows($q);
        $brimo = $this->Brimo_model->get_limit_data($config['per_page'], $start, $q);
