...
class Kpr extends CI_Controller
{
    ...
    public function read($id) 
    {
		...
		'plafond' => $row->plafond,
            ...
            $this->load->view('kpr/kpr_read', $data);
        } else {
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('kpr/create_action'),
	    'id' => set_value('id'),
	    'pn' => set_value('pn'),
	    'tgl' => set_value('tgl'),
        ...
        $this->load->view('kpr/kpr_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('kpr/update_action'),
	...
	foreach ($this->Kpr_model->get_all() as $data) {
            $kolombody = 0;
