...
class Ekstrakom extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'ekstrakom/index.html?q=' . urlencode($pn);
            $config['first_url'] = base_url() . 'ekstrakom/index.html?q=' . urlencode($pn);
        } else {
        ...
        $ekstrakom = $this->Ekstrakom_model->get_limit_data($config['per_page'], $start, $pn);
