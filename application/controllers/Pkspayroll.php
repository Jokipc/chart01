...
class Pkspayroll extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'pkspayroll/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'pkspayroll/index.html?q=' . urlencode($q);
        } else {
        ...
        $config['total_rows'] = $this->Pkspayroll_model->total_rows($q);
        $pkspayroll = $this->Pkspayroll_model->get_limit_data($config['per_page'], $start, $q);
