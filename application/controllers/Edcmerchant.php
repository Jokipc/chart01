...
class Edcmerchant extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'edcmerchant/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'edcmerchant/index.html?q=' . urlencode($q);
        } else {
        ...
        $config['total_rows'] = $this->Edcmerchant_model->total_rows($q);
        $edcmerchant = $this->Edcmerchant_model->get_limit_data($config['per_page'], $start, $q);
