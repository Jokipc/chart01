...
class Bristore extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'bristore/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'bristore/index.html?q=' . urlencode($q);
        } else {
        ...
        $config['total_rows'] = $this->Bristore_model->total_rows($q);
        $bristore = $this->Bristore_model->get_limit_data($config['per_page'], $start, $q);
