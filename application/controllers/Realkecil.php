...
class Realkecil extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'realkecil/index.html?q=' . urlencode($pn);
            $config['first_url'] = base_url() . 'realkecil/index.html?q=' . urlencode($pn);
        } else {
        ...
        $realkecil = $this->Realkecil_model->get_limit_data($config['per_page'], $start, $pn);
