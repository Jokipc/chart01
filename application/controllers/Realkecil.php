...
class Realkecil extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'realkecil/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'realkecil/index.html?q=' . urlencode($q);
        } else {
        ...
        $config['total_rows'] = $this->Realkecil_model->total_rows($q);
        $realkecil = $this->Realkecil_model->get_limit_data($config['per_page'], $start, $q);
