...
class Rektab extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'rektab/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'rektab/index.html?q=' . urlencode($q);
        } else {
        ...
        $config['total_rows'] = $this->Rektab_model->total_rows($q);
        $rektab = $this->Rektab_model->get_limit_data($config['per_page'], $start, $q);
