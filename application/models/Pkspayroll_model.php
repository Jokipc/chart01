...
class Pkspayroll_model extends CI_Model
{

    public $table = 'pkspayroll';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function total_rows1($pn = NULL, $pn1 = NULL) {
        ...
        $this->db->where('pn', $pn1);
        $this->db->or_like('nama_pkspayroll', $pn);
        $this->db->where('pn', $pn1);
...
/* End of file Pkspayroll_model.php */
/* Location: ./application/models/Pkspayroll_model.php */
