...
class Action_model extends CI_Model
{
	...
	$this->db->or_like('tgl_action', $q);
	$this->db->or_like('kunjual', $q);
	$this->db->or_like('trgt_kunjual', $q);
	$this->db->or_like('lupus', $q);
	$this->db->or_like('trgt_lupus', $q);
	$this->db->or_like('tagih', $q);
	$this->db->or_like('trgt_penagihan', $q);
