...
class Bristore_model extends CI_Model
{

    public $table = 'bristore';
    public $id = 'id';
    public $order = 'DESC';
...
/* End of file Bristore_model.php */
/* Location: ./application/models/Bristore_model.php */
