...
class Home_model extends CI_Model{
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(brimo.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(qris.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(kunjual.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(saving.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(stroberikasir.tgl)',7);
  ...
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(bankgaransi.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(bristore.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(ibbiz.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(pkspayroll.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(rekgiro.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(rektab.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(brimolajs.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(dg_saving.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(edcmerchant.tgl)',7);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(britamabisnis.tgl)',7);
  ...
  $this->db->select_sum('plafond');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(premi.tgl)',7);
  ...
  $this->db->select_sum('plafond');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(penyalurankur.tgl)',7);
  ...
  $this->db->select_sum('plafond');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(realkecil.tgl)',7);
  ...
  $this->db->select_sum('plafond');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(ekstrakom.tgl)',7);
  ...
  $this->db->select_sum('plafond');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(briguna.tgl)',7);
