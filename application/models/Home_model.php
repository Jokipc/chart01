...
class Home_model extends CI_Model{
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(brimo.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(qris.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(kunjual.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(saving.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(stroberikasir.tgl)',6);
  ...
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(bankgaransi.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(bristore.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(ibbiz.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(pkspayroll.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(rekgiro.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(rektab.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(brimolajs.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(dg_saving.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(edcmerchant.tgl)',6);
  ...
  $this->db->select('pn');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(britamabisnis.tgl)',6);
  ...
  $this->db->select_sum('plafond');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(premi.tgl)',6);
  ...
  $this->db->select_sum('plafond');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(penyalurankur.tgl)',6);
  ...
  $this->db->select_sum('plafond');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(realkecil.tgl)',6);
  ...
  $this->db->select_sum('plafond');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(ekstrakom.tgl)',6);
  ...
  $this->db->select_sum('plafond');
  $this->db->where('pn',$pn);
  $this->db->where('MONTH(briguna.tgl)',6);
