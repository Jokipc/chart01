...
class Kunjual_model extends CI_Model
{

    public $table = 'kunjual';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function total_rows1($pn = NULL, $pn1 = NULL) {
	    ...
	    $this->db->or_like('pn', $pn);
	    $this->db->or_like('tgl', $pn);
	    $this->db->or_like('nik', $pn,"match");
        $this->db->where('pn', $pn1);
        $this->db->or_like('nama_nasabah', $pn,"match");
        $this->db->where('pn', $pn1);
...
/* End of file Kunjual_model.php */
/* Location: ./application/models/Kunjual_model.php */
