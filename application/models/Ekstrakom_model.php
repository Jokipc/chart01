...
class Ekstrakom_model extends CI_Model
{

    public $table = 'ekstrakom';
    public $id = 'id';
    public $order = 'DESC';
	...
	$this->db->limit($limit, $start);
     ...
     // get total rows
     function total_rows1($pn = NULL, $pn1 = NUL) {
...
/* End of file Ekstrakom_model.php */
/* Location: ./application/models/Ekstrakom_model.php */
