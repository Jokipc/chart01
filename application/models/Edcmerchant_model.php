...
class Edcmerchant_model extends CI_Model
{

    public $table = 'edcmerchant';
    public $id = 'id';
    public $order = 'DESC';
	...
	$this->db->or_like('id_merchant', $pn);
...
/* End of file Edcmerchant_model.php */
/* Location: ./application/models/Edcmerchant_model.php */
